...
function matchWithChecks(segmentGroup, route, segments, injector, urlSerializer, createSnapshot, abortSignal) {
  ...
  return runCanMatchGuards(injector, route, segments, urlSerializer, currentSnapshot, abortSignal).pipe((0, import_operators.map)((v) => v === true ? result : {
    ...noMatch
  }));
}
...
//# sourceMappingURL=chunk-M7NI3IL7.js.map
