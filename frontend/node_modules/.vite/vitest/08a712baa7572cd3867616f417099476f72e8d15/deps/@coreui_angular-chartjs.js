...
var TAU = 2 * PI;
var PITAU = TAU + PI;
var INFINITY7 = Number.POSITIVE_INFINITY;
...
function set2(root2, scope, values2) {
  if (typeof scope === "string") {
    return merge2(getScope$1(root2, scope), values2);
  }
...
function getContainerSize(canvas, width, height) {
  ...
  return {
    width,
    height,
    maxWidth: maxWidth || INFINITY7,
    maxHeight: maxHeight || INFINITY7
  };
}
...
function getMaximumSize(canvas, bbWidth, bbHeight, aspectRatio) {
  ...
  const maxWidth = parseMaxStyle(style.maxWidth, canvas, "clientWidth") || INFINITY7;
  const maxHeight = parseMaxStyle(style.maxHeight, canvas, "clientHeight") || INFINITY7;
...
var Scale = class _Scale extends Element {
  ...
  update(maxWidth, maxHeight, margins) {
    ...
    this._convertTicksToLabels(samplingEnabled ? sample2(this.ticks, sampleSize2) : this.ticks);
    this.configure();
  ...
  _getLabelSizes() {
    ...
    if (!labelSizes) {
      ...
      if (sampleSize2 < ticks.length) {
        ticks = sample2(ticks, sampleSize2);
      }
...
var ChartjsComponent = class _ChartjsComponent {
   ...
   * @default true
   */
  customTooltips = input(true, { ...ngDevMode ? { debugName: "customTooltips" } : (
   ...
   */
  idInput = input(`c-chartjs-${nextId++}`, { ...ngDevMode ? { debugName: "idInput" } : (
    /* istanbul ignore next */
    {}
  ), alias: "id" });
  get id() {
   ...
   * @default {}
   */
  optionsInput = input({}, { ...ngDevMode ? { debugName: "optionsInput" } : (
    /* istanbul ignore next */
    {}
  ), alias: "options" });
   ...
   * @default false
   */
  redraw = input(false, { ...ngDevMode ? { debugName: "redraw" } : (
    /* istanbul ignore next */
    {}
  ), transform: booleanAttribute });
  /**
   ...
   * @default true
   */
  wrapper = input(true, { ...ngDevMode ? { debugName: "wrapper" } : (
    /* istanbul ignore next */
    {}
  ), transform: booleanAttribute });
  ...
  chartCustomTooltips() {
    ...
    untracked(() => {
      this.options.set(merge_default({
        ...options,
        plugins: {
          ...plugins2,
          tooltip: {
...
}], ctorParameters: () => [], propDecorators: { customTooltips: [{ type: Input, args: [{ isSignal: true, alias: "customTooltips", required: false }] }], data: [{ type: Input, args: [{ isSignal: true, alias: "data", required: false }] }], height: [{ type: Input, args: [{ isSignal: true, alias: "height", required: false }] }], idInput: [{ type: Input, args: [{ isSignal: true, alias: "id", required: false }] }], optionsInput: [{ type: Input, args: [{ isSignal: true, alias: "options", required: false }] }], plugins: [{ type: Input, args: [{ isSignal: true, alias: "plugins", required: false }] }], redraw: [{ type: Input, args: [{ isSignal: true, alias: "redraw", required: false }] }], type: [{ type: Input, args: [{ isSignal: true, alias: "type", required: false }] }], width: [{ type: Input, args: [{ isSignal: true, alias: "width", required: false }] }], wrapper: [{ type: Input, args: [{ isSignal: true, alias: "wrapper", required: false }] }], getDatasetAtEvent: [{ type: Output, args: ["getDatasetAtEvent"] }], getElementAtEvent: [{ type: Output, args: ["getElementAtEvent"] }], getElementsAtEvent: [{ type: Output, args: ["getElementsAtEvent"] }], chartRef: [{ type: Output, args: ["chartRef"] }], canvasElement: [{ type: ViewChild, args: ["canvasElement", { isSignal: true }] }] } });
var ChartjsModule = class _ChartjsModule {
  static ɵfac = ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.10", ngImport: core_exports, type: _ChartjsModule, deps: [], target: FactoryTarget.NgModule });
  static ɵmod = ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.10", ngImport: core_exports, type: _ChartjsModule, imports: [ChartjsComponent], exports: [ChartjsComponent] });
  static ɵinj = ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.10", ngImport: core_exports, type: _ChartjsModule });
};
ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.10", ngImport: core_exports, type: ChartjsModule, decorators: [{
  type: NgModule,
  args: [{
    imports: [
      ChartjsComponent
